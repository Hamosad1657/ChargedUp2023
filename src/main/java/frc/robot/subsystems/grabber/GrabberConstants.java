...
public class GrabberConstants {
	...
	public static final Color kCubeMaxColor = new Color(0.45, 0.49, 0.264);

	public static final double kConeMinDistance = 0;
	...
	public static final int kMaxCubeAmper = 0;
	public static final int kMaxConeAmper = 0;
